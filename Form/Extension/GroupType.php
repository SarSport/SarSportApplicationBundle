...
class GroupType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'choices'=> array(
                Application::APPLICATION_GROUP_MM_VALUE => Application::APPLICATION_GROUP_MM_NAME,
                Application::APPLICATION_GROUP_MW_VALUE => Application::APPLICATION_GROUP_MW_NAME,
                Application::APPLICATION_GROUP_MMR_VALUE => Application::APPLICATION_GROUP_MMR_NAME,
